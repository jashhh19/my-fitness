...
<head>
    ...
    <title>Admin</title>
    <link rel="shortcut icon" type="image/x-icon" href="img/TT.png">
</head>
<body>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="admin-login.php"><img src="img/TT.png" alt="Tuitions Tonight Logo" style="width: 150px !important; height: 100px !important;"></a>
